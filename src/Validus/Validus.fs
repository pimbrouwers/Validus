    ...
    type StringValidator() =
        ...
        member _.empty (message : string option) : Validator<string> =
            fun (field : string) (value : string) ->
                ...
                ValidationResult.create (String.IsNullOrWhiteSpace(value)) value (messageOrDefault field message defaultMessage)
        ...
        member _.notEmpty (message : string option) : Validator<string> =
            fun (field : string) (value : string) ->
                ...
                ValidationResult.create (not(String.IsNullOrWhiteSpace(value))) value (messageOrDefault field message defaultMessage)
