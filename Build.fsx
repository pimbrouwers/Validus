...
let assemblyName = "Validus"
let assemblyPath = Path.Join(__SOURCE_DIRECTORY__, "src", assemblyName)
...
Command.runDotnet assemblyPath "clean" "-c Release --nologo --verbosity quiet"
Command.runDotnet assemblyPath "restore" "--force --force-evaluate --nologo --verbosity quiet"
Command.runDotnet assemblyPath "build" "--no-restore --nologo --verbosity quiet"